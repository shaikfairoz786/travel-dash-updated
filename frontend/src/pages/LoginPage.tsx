...
const LoginPage: React.FC = () => {
  ...
  const backgroundImage = "https://images.unsplash.com/photo-1500835556837-99ac94a94552?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D";
  ...
  return (
    <div className="min-h-screen flex">
      ...
      >
        <div className="absolute inset-0 bg-gradient-to-br from-stone-900/70 to-primary-900/70 backdrop-blur-[2px]"></div>
        <div className="relative z-10 w-full h-full flex flex-col justify-center items-center text-white p-12">
          <div className="flex flex-col items-center justify-center max-w-md">
            <div className="mb-8">
              <div className="bg-white/20 backdrop-blur-md p-6 rounded-2xl mb-6 shadow-lg border border-white/10">
